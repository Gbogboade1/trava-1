...
class HistoryDeliveredResponse {
  bool? status;
  String? message;
  List<Data>? data;
  String? token;

  HistoryDeliveredResponse({this.status, this.message, this.token, this.data});

  HistoryDeliveredResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
