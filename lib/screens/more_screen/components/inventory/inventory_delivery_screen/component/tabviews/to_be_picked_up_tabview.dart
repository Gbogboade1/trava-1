                                  ...
                                  child: RichText(
                                    text: TextSpan(
                                      ...
                                      children: [
                                        TextSpan(
                                            text:
                                                "Package (${snapshot.data!.data![index].deliveryCode}) from ${snapshot.data!.data![index].sender!.firstName} ${snapshot.data!.data![index].sender!.lastName} is yet to be picked up. "),
                                        TextSpan(
